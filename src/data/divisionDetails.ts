      ...
      areas: [
        {
          ...
          title: 'AI, Data, and Computing',
          topics: [
            'Artificial intelligence, machine learning, and deep learning',
            'Big data analytics, data science, and predictive analytics',
            'Computer vision, signal processing, and image processing',
          ],
        },
        {
          id: 'secure-connected-systems',
          title: 'Secure and Connected Systems',
          topics: [
            'Cybersecurity, applied cryptography, and cyber-physical systems',
            'Next-generation wireless networks, Internet of Things, and mobile computing',
            'Quantum computing and distributed systems',
          ],
        },
        {
          id: 'hardware-power-intelligent-systems',
          title: 'Hardware, Power, and Intelligent Systems',
          topics: [
            'VLSI, integrated circuits, smart sensors, and wearable electronics',
            'Power electronics, smart grids, and renewable energy systems',
            'Intelligent control, robotics, and autonomous systems',
          ],
        },
        {
          id: 'human-health-visual-computing',
          title: 'Human, Health, and Visual Computing',
          topics: [
            'Scientific visualization, computer graphics, and visual computing',
            'Human-computer interaction, inclusive design, and digital wellbeing',
            'Health informatics, digital health, and computational bioinformatics',
          ],
        },
      ],
    },
